...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/jscss/admin/design/">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/jscss/admin/design/">配送人员管理</a><span class="crumb-step">&gt;</span><span>新增配送人员</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="conn_admin/DoSenderAdd.php" method="post" id="myform" name="myform" enctype="multipart/form-data">
