...
<?php
  ...
  $id = $_GET['id'];
  $sql = "select * from tb_worker where id = $id";
  $res = $pdo -> query($sql);
  $row = $res -> fetch();
 ?>
 <!doctype html>
     ...
     <div class="main-wrap">
         ...
         <div class="result-wrap">
             <div class="result-content">
                 <form action="conn_admin/DoSenderAlt.php" method="post" id="myform" name="myform" enctype="multipart/form-data">
                     ...
                     <table class="insert-tab" width="100%">
                       <tbody>
                           ...
                           <tr>
                               ...
                               <td>
                                   <input class="common-text required" id="title" name="phone" size="50" value="<?php echo $row['phone'] ?>" type="text">
                               </td>
                           </tr>
                           <tr>
                               <th><i class="require-red">*</i>工作态度：</th>
                               <td>
                                   <input class="common-text required" id="title" name="cred" size="50" value="<?php echo $row['cred'] ?>" type="text">
                               </td>
                           </tr>
                           <tr>
                               <th></th>
