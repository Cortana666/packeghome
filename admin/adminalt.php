     ...
     <div class="main-wrap">
         ...
         <div class="result-wrap">
             <div class="result-content">
                 <form action="conn_admin/DoAdminAlt.php" method="post" id="myform" name="myform" enctype="multipart/form-data">
                     ...
                     <table class="insert-tab" width="100%">
                       <tbody>
                           <tr>
                               ...
                               <td>
                                   <input class="common-text required" id="title" name="username" size="50" value="<?php echo $row['username'] ?>" type="text">
                               </td>
                           </tr>
                           <tr>
                               <th><i class="require-red">*</i>密码：</th>
                               <td>
                                   <input class="common-text required" id="title" name="password" size="50" value="<?php echo $row['password'] ?>" type="text">
                               </td>
                           </tr>
                           <tr>
                               <th></th>
