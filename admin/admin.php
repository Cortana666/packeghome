            ...
            <form name="myform" id="myform" method="post" action="conn_admin/DoAdminDeleteSomes.php">
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php
                          $res_s = $pdo -> query("select * from tb_admin");
                          $count = $pdo -> query("select count(*) from tb_Admin");
                          foreach ($res_s as $key => $show) {
                            ...
                            echo "<tr>
                               ...
                               <td>".$show['password']."</td>
                               <td>
                                   <a class=\"link-update\" href=\"adminalt.php?id=".$show_id."\">修改</a>
                                   <a class=\"link-del\" href=\"conn_admin/DoAdminDelete.php?del_id=".$show_id."\">删除</a>
                               </td>
                           </tr>";
                          }
                         ?>
